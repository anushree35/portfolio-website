...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Test: Remove active from home initially
...
document.querySelectorAll('.nav-link').forEach(link => {
    link.addEventListener('click', (e) => {
        ...
        // Update again after smooth scroll
        setTimeout(updateActiveNavLink, 1200);
    });
});
...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.timeline-item, .project-card, .skill-item, .cert-item, .award-card, .stat');
